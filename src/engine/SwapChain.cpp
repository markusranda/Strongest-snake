...
SwapChain::~SwapChain()
{
    // Destructor doesn’t own device, so caller must pass it to cleanup()
...
void SwapChain::create(VkPhysicalDevice physicalDevice,
                       VkDevice device,
...
void SwapChain::createFramebuffers(VkDevice device, VkRenderPass renderPass, VkImageView colorImageView, VkSampleCountFlagBits msaaSamples)
{
